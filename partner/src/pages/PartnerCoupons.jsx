    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-[#DE7A3E] to-[#7596DB] rounded-xl p-6 text-white">
                <h1 className="text-3xl   mb-2">My Coupons 🎫</h1>
                <p className="text-orange-100 text-lg">
                    Manage and track your assigned coupon codes for rhoseatte.
                </p>
            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl   text-gray-900 mt-2">{coupons.length}</p>
                            </div>
                ...
                {coupons.length === 0 ? (
                    ...
                    <Card className="shadow-lg border-0">
                        <CardContent className="p-12 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">No matching coupons</h3>
                            <p className="text-gray-600 max-w-md mx-auto">
                                Try a different search term for code or description.
                            </p>
                        </CardContent>
                    </Card>
                ) : (
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-3">
                                            <div className="flex items-center gap-2">
                                                <h3 className="text-2xl   text-gray-900">{coupon.code}</h3>
                                                <Button
                                                    variant="ghost"
                                                    size="sm"
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            ...
                                            <div className="bg-gray-50 p-3 rounded-lg">
                                                ...
                                                <p className="  text-lg text-orange-600">{coupon.commission}%</p>
                                            </div>
                                            <div className="bg-gray-50 p-3 rounded-lg">
