...
// Get all categories with their subcategories (supports optional pagination)
export const getAllCategories = asyncHandler(async (req, res) => {
  ...
  else if (sort === "popular") orderBy = { products: { _count: "desc" } };

  // If pagination params are present, apply pagination
  if (page || limit) {
  ...
  // No pagination — return all categories (backward compatible)
