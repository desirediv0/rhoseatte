...
export default function DashboardLayout() {
  ...
  useEffect(() => {
    ...
    if (path.startsWith("/secret-access")) {
      setOpenSections({
        products: false,
        orders: false,
        users: false,
    ...
    } else if (path.startsWith("/fragrance-quiz")) {
      setOpenSections({
        products: false,
        orders: false,
        users: false,
    ...
    } else if (path.startsWith("/products") || path.startsWith("/brands") || path.startsWith("/categories") || path.startsWith("/attributes")) {
      setOpenSections({
        products: true,
        orders: false,
        users: false,
          ...
          <SafeRender>
            <div className="flex flex-col gap-0.5">
              ...
              <CollapsibleNavItem
                ...
                icon={<Shield className="h-[1.125rem] w-[1.125rem]" />}
                isOpen={openSections.secretAccess}
                onToggle={() => toggleSection("secretAccess")}
                children={[
                  {
                    href: "/secret-access",
                    title: "Dashboard",
                  ...
                  {
                    href: "/secret-access/pending",
                    title: "Pending Orders",
                    hasPermission: true,
                  },
                  {
                    href: "/secret-access/issued",
                    title: "Issued Codes",
                    hasPermission: true,
                  },
                ]}
              ...
              {/* Fragrance Finder - Collapsible */}
              <CollapsibleNavItem
                title="Fragrance Finder"
                icon={<Sparkles className="h-[1.125rem] w-[1.125rem]" />}
                isOpen={openSections.fragranceQuiz}
                onToggle={() => toggleSection("fragranceQuiz")}
                children={[
                  {
                    href: "/fragrance-quiz",
                    title: "Dashboard",
                    hasPermission: hasPermissionFor(
                      admin,
                      Resource.FRAGRANCE_QUIZ,
                      Action.READ
                    ),
                  },
                  {
                    href: "/fragrance-quiz/questions",
                    title: "Questions",
