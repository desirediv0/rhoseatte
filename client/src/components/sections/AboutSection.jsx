...
const features = [
  ...
  },
  {
    ...
    description: "100% pure & fresh products",
  },
  {
    icon: CreditCard,
      ...
      <div className="section-container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl   text-foreground mt-2 mb-4">
            India&apos;s Trusted Nutritional Grocery Store
          </h2>
          <p className="text-muted-foreground text-lg">
            25+ years of excellence in providing pure, farm-fresh nutritional products. Quality essentials at the best prices.
          </p>
        </div>
