            ...
            <div className="section-container py-12">
                <div className="grid lg:grid-cols-4 gap-8">
                    ...
                    <aside className="lg:col-span-1">
                        <div className="bg-white rounded-2xl p-6 sticky top-24">
                            ...
                            <div className="text-center mb-6 pb-6 border-b border-border">
                                <div className="w-20 h-20 bg-foreground text-white rounded-full flex items-center justify-center text-3xl   mx-auto mb-4">
                                    {user?.name?.charAt(0) || "U"}
                                </div>
                                <h2 className="font-display   text-lg">{user?.name || "User"}</h2>
                    ...
                    <main className="lg:col-span-3">
                        ...
                        {activeTab === "account" && (
                            <div>
                                <h1 className="font-display text-2xl   mb-6">Account Details</h1>
