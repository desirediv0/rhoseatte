            ...
            <section className="bg-section-white section-padding">
                <div className="section-container max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none">
                        <h2 className="font-display text-2xl   mb-4">Warranty Coverage</h2>
                        <p className="mb-4">
                        ...
                        <h2 className="font-display text-2xl   mb-4">How to Claim Warranty</h2>
                        <p className="mb-4">
                        ...
                        <h2 className="font-display text-2xl   mb-4">Warranty Terms</h2>
                        <ul className="space-y-2 mb-8">
                        ...
                        <h2 className="font-display text-2xl   mb-4">Service Centers</h2>
                        <p className="mb-4">
                        ...
                        <h2 className="font-display text-2xl   mb-4">Extended Warranty</h2>
                        <p className="mb-8">
                        ...
                        <h2 className="font-display text-2xl   mb-4">Contact Warranty Support</h2>
                        <p className="mb-4">
